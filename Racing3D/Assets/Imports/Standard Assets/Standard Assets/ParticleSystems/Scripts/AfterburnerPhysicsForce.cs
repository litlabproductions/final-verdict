...
namespace UnityStandardAssets.Effects
{
    ...
    public class AfterburnerPhysicsForce : MonoBehaviour
    {
        ...
        private void Start()
        {
            afterBurnerParticles = GetComponent<ParticleSystem>();
        }
        ...
        private void FixedUpdate()
        {
            ...
            for (int n = 0; n < m_Cols.Length; ++n)
            {
                if (m_Cols[n].attachedRigidbody != null)
                {
                    ...
                    afterBurnerParticles.startSize = carRB.velocity.z * 0.1f;
                    afterBurnerParticles.startSpeed = carRB.velocity.z * 0.1f;
                }
            }
        }
